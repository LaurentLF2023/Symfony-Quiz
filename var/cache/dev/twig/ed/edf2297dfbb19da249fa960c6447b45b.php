...
class __TwigTemplate_e46faac7163143223ae7e8940409aff5 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 7
        echo "\t<div style=\"flex: 2; text-align: center;\">
\t\t<h1>Votre Score</h1>
\t\t<h2><strong>";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["result"]) || array_key_exists("result", $context) ? $context["result"] : (function () { throw new RuntimeError('Variable "result" does not exist.', 9, $this->source); })()), "html", null, true);
        echo "/";
        echo twig_escape_filter($this->env, (isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 9, $this->source); })()), "html", null, true);
        echo "</strong></h2>
\t</div>
";
    ...
    {
        return array (  93 => 9,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t<h1>Votre Score</h1>
\t\t<h2><strong>{{ result }}/{{ count }}</strong></h2>
\t</div>
{% endblock %}

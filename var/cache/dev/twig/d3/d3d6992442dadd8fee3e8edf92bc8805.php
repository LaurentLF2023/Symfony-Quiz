...
class __TwigTemplate_2fe11586fc235dc68d0d61307096a031 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 21
        echo twig_escape_filter($this->env, (isset($context["result"]) || array_key_exists("result", $context) ? $context["result"] : (function () { throw new RuntimeError('Variable "result" does not exist.', 21, $this->source); })()), "html", null, true);
        echo "/";
        echo twig_escape_filter($this->env, (isset($context["count"]) || array_key_exists("count", $context) ? $context["count"] : (function () { throw new RuntimeError('Variable "count" does not exist.', 21, $this->source); })()), "html", null, true);
        echo "
\t</div>
";
    ...
    {
        return array (  105 => 21,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }

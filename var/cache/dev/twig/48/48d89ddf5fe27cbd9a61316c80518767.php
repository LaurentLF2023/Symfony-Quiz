...
class __TwigTemplate_90d997374d118a34adc99fd1a38695b9 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/home/laurentlf/epitech/projets/semestre2/quiz/W-PHP-502-NAN-2-1-Quiz-marius.le-houezec-lacaze/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}

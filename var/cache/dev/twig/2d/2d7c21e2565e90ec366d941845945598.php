...
/* quizz/new.html.twig */
class __TwigTemplate_7810c15f509cb153893e0c56d9f0ad1a extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 21
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), 'form_start', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_quizz_new"), "method" => "POST"]);
        echo "
\t\t";
        // line 22
        ...
        echo "
\t\t<button type=\"submit\">Nouveaux Quizz</button>
\t\t";
        // line 24
...
";
    ...
    {
        return array (  114 => 24,  109 => 22,  105 => 21,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t<div class=\"example-wrapper\">
\t\t{{ form_start(form, {'action': path('app_quizz_new'), 'method': 'POST'}) }}
\t\t{{ form_widget(form) }}
\t\t<button type=\"submit\">Nouveaux Quizz</button>
\t\t{{ form_end(form) }}
\t</div>
{% endblock %}
", "quizz/new.html.twig", "/home/laurentlf/epitech/projets/semestre2/quiz/W-PHP-502-NAN-2-1-Quiz-marius.le-houezec-lacaze/templates/quizz/new.html.twig");
    }
}

...
class __TwigTemplate_333c67ef7d3fd9ef0c6152539d0fc9d5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_ea_crud_widget($context, array $blocks = [])
    {
        ...
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["ea_crud_form"]) || array_key_exists("ea_crud_form", $context) ? $context["ea_crud_form"] : (function () { throw new RuntimeError('Variable "ea_crud_form" does not exist.', 420, $this->source); })()), "form_tabs", [], "any", false, false, false, 420)) > 0)) {
            ...
            foreach ($context['_seq'] as $context["tab_name"] => $context["tab_config"]) {
                ...
                // line 430
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tab_config"], "label", [], "array", false, false, false, 430), "html", null, true);
                // line 431
...
{% endblock %}
", "@EasyAdmin/crud/form_theme.html.twig", "/home/laurentlf/epitech/projets/semestre2/quiz/W-PHP-502-NAN-2-1-Quiz-marius.le-houezec-lacaze/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/form_theme.html.twig");
    }
}
